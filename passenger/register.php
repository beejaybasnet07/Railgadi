...
<div class="container" style="background-color:#d9d9d9">
    <div class="row">
        <div class="col offset-md-9 mt-2">
            <p class="text-black-50 font-weight-bold">Already have an Account ?? &nbsp;<a href="../passenger/login.php" class="stretched-link">LOGIN</a><p>
        </div>
    ...
    <div class="row" >
        <div class="col-md  mb-5 pb-1" id="main" style="background:white;">
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="row" id="row1" style="background-color:#d9d9d9">
                ...
                <div class="row" id="row2" style="background-color:#d9d9d9">
                    <div class="col-md-5 pt-3">
                        <div class="form-group">
                            <div class="form-label-group">
                ...
                <div class="row" id="row3" style="background-color:#d9d9d9">
                    <div class="col-md-5 pt-3">
                        <div class="form-group">
                            <div class="form-label-group">
                ...
                <div class="row" id="row4" style="background-color:#d9d9d9">
                    <div class="col-md-5 pt-3">
                        <div class="form-group">
                            <div class="form-label-group">
