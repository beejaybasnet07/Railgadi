...
<?php 
    ...
    if($train){
        ...
        $sql = 'INSERT INTO train (name, tnumber, arrival_time, departure_time, date, _from, _to, ac2price, ac3price, sprice)
                 VALUES (:name, :tnumber, :arrival_time, :departure_time, :date, :from, :to, :ac2price, :ac3price, :sprice)';
