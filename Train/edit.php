...
<?php 
    ...
    if($train){
        ...
        $sql = 'UPDATE train SET name=:name, tnumber=:tnumber, arrival_time=:arrival_time, departure_time=:departure_time, date=:date, time=:time, _from=:_from, _to=:_to, ac2price=:ac2price, ac3price=:ac3price, sprice=:sprice WHERE id=:id';
