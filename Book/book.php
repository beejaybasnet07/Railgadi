...
$result = $stmt->fetch();
?>
<div class="container mt-2 pb-5"style="background-color:#f8f9fa;">
    ...
    <div class="container">
        ...
        <div class="container" style=" border: 2px whitesmoke solid; background-color:white;">
            <div class="row">
                <div class="col my-3">
    ...
    <div class="row">
        <div class="col-2 ml-3 py-2 pr-2 mt-2 pt-2">
